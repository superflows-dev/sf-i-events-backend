...
export const processUploadAudit1 = async (event) => {
    
    console.log('processing audit', event.body);
    ...
    while(!flag && index < 5){
        ...
        dbComments.push({"author":"Auditor", "username": username, "comment": commentsText, "timestamp": (new Date()).toUTCString() + ""})
