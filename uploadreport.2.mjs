...
export const processUploadReport2 = async (event) => {
    ...
    let percentage = "100";
    try {
        percentage = JSON.parse(event.body).percentage ?? "100";
    }catch(e){
        console.log('error', e);
    }
    ...
    processAddLog('1234', 'uploadReport', event, response, response.statusCode)
    return response;
