...
export const processUploadReportsBulk1 = async (event) => {
    ...
    if(parseInt(retryattempts) >= REPORTING_RETRY_LIMIT){
        ...
        Name: "RULE_Report_" + projectid + "_" + (new Date().getTime()), // required
